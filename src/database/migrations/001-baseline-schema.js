// Baseline schema — reproduces the tables that existed before versioned
// migrations were introduced. Fresh databases and existing databases both
// reach the final schema by running the full migration path in order.
module.exports = {
  version: 1,
